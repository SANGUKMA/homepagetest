...
| 상태 | **Phase 1 완료 · 배포 운영 중** — https://univhomepagetest.vercel.app (2026-07-29) |
| 잔여 | Turnstile·알림 메일 키 미설정 · 콘텐츠 원문/약관 초안 상태 — `docs/prd.md` §12.2 |

**Phase 1 확정 사항** (상세는 `docs/prd.md` §12)

| 항목 | 결정 |
|---|---|
| 관리자 인증 | 인증자 = 관리자. `profiles.role`은 Phase 2. **Supabase 공개 회원가입은 반드시 꺼 둔다** — 켜져 있으면 가입자가 곧 관리자가 된다 |
